...
class Gold(object):
    ...
    MAX_INCREASING_VALUE = ceil(INITIAL_VALUE * (100+MAX_GOLD_VALUE_INCREASING_PERCENT) / 100)
    MAX_DECREASING_VALUE = floor(INITIAL_VALUE * (100-MAX_GOLD_VALUE_DECREASING_PERCENT) / 100)
